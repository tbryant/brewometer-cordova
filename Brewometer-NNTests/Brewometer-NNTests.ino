...
float calRangesHigh[3] = {80.0, 55.0, 30.0};  //upper bounds for angle at cal set points
float calRangesLow[3] = {55.0, 30.0, 5.0}; //lower bounds for angle at cal set points
